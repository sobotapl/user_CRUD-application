                ...
                <div class="card shadow mb-4">
                    ...
                    <div class="card-body">
                        <form action="/users/edit" method="post">
                            <div class="mb-3"><label for="username">Nazwa</label><input
                                    class="form-control" id="username" name="username" value="${user.username}" type="text"
                                    placeholder="Nazwa użytkownika"></div>
                            <div class="mb-3"><label for="email">Email</label><input
                                    class="form-control" id="email" name="email" value="${user.email}" type="email"
                                    placeholder="Email użytkownika"></div>
                            <div class="mb-3">
